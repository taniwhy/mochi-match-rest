...
type IRoomRepository interface {
	...
	FindByLimitAndOffsetAndTitleAndHard(limit, offset int, titles, hards []string) ([]*output.RoomResBody, error)
	...
	FindUnlockCountByIDAndTitleAndHard(titles, hards []string) (*int, error)
